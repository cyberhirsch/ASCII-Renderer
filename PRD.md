...
| **Materials** | Soil depth falls off with slope (bare rock on hillsides); stone below. Ore veins are the intersection curves of two noise fields — branching tubes, 0.25% of rock — iron deep; above that, tin inside its own provinces (~20% of the map) and copper everywhere else, so bronze cannot be smelted without travelling. Gems in deep vein cores at 0.008%. |
